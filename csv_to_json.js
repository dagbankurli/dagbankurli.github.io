 ...
 * Usage: node csv_to_json.js [output.json]
 *        Converts all three: words, phrases, idioms -> single JSON file.
 *        Or: node csv_to_json.js words  (words only)
 *        Or: node csv_to_json.js phrases (phrases only)
 *        Or: node csv_to_json.js idioms  (idioms only)
 */
const fs = require('fs');
